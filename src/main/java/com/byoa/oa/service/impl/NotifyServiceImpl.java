...
import com.byoa.oa.dao.NotifyDao;
import com.byoa.oa.dao.NotifyRecordDao;
import com.byoa.oa.domain.NotifyDO;
import com.byoa.oa.domain.NotifyDTO;
import com.byoa.oa.domain.NotifyRecordDO;
import com.byoa.oa.service.NotifyService;
...
import com.byoa.common.service.DictService;
import com.byoa.common.utils.DateUtils;
...
public class NotifyServiceImpl implements NotifyService {
    ...
    public int save(NotifyDO notify) {
        ...
        executor.execute(new Runnable() {
            @Override
            public void run() {
                for (UserDTO userDO : sessionService.listOnlineUser()) {
                    for (Long userId : userIds) {
