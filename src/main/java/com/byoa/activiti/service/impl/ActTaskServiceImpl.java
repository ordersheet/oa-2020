...
public class ActTaskServiceImpl implements ActTaskService {
    ...
    public String startProcess(String procDefKey, String businessTable, String businessId, String title, Map<String, Object> vars) {
        ...
        //使用UserName 作为启动流程的人员ID
        String userId = ShiroUtils.getUser().getName();//ObjectUtils.toString(UserUtils.getUser().getId())
        ...
        if (StringUtils.isNotBlank(title)) {
            vars.put("title", title);
            vars.put("userName",ShiroUtils.getUser().getUsername());
        }
        // 启动流程
        // procDefKey = salary  businessId = salary.id
        ProcessInstance procIns = runtimeService.startProcessInstanceByKey(procDefKey, businessId, vars);
        System.out.println("流程BusinessKey(业务表编号)"+procIns.getBusinessKey());
        System.out.println("流程部署编号:"+procIns.getDeploymentId());
        System.out.println("流程ID:"+procIns.getId());
        System.out.println("流程定义ID:"+procIns.getProcessDefinitionId());
        return null;
    }
