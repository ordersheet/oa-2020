        ...
        .bootstrapTable(
            {
                ...
                columns: [
                    ...
                    },
                    {
                     ...
                     align:'center',
                     formatter:function (value,row,index) {
                         var f = '<a class="btn btn-primary btn-sm " href="#" title="任务详情"  mce_href="#" onclick="his(\''
                             + row.processDefinitionId+ '\')">详情<i class="fa fa-key"></i></a> ';
                         return f;
                     }
                    }
                   ]
