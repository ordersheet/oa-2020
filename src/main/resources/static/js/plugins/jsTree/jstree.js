...
(function (factory) {
    ...
    $.jstree.core.prototype = {
         ...
         * @name get_selected([fullc])
         * @param  {mixed}  full if set to `true` the returned array will consist of the fullc node objects, otherwise - only IDs will be returned
         * @return {Array}
         */
         ...
         * @name get_bottom_selected([fullc])
         * @param  {mixed}  full if set to `true` the returned array will consist of the fullc node objects, otherwise - only IDs will be returned
         * @return {Array}
         */
