    ...
    function Plyr(container) {
        ...
        function _toggleFullscreen(event) {
            ...
            // If there's native support, use it
                ...
                // Check if we're actually fullc screen (it could fail)
                player.isFullscreen = fullscreen.isFullScreen(player.container);
            } else {
        ...
        function _toggleCaptions(show) {
            // If there's no fullc support, or there's no caption toggle
        ...
        function _init() {
            ...
            if (player.type == 'video' || player.type == 'audio') {
                ...
                if (!player.supported.full) {
                    ...
                    // Don't inject controls if no fullc support
                    return;
                }
