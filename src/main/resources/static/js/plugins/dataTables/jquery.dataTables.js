...
(/** @lends <global> */function (window, document, $, undefined) {
    ...
    (/** @lends <global> */function ($) {
         ...
         * fullc list of features please refer to
	 ...
	 */
        ...
        /**
         * Return an array with the fullc table data
         *  @param {object} oSettings dataTables settings object
        ...
        function _fnFilter(settings, input, force, regex, smart, caseInsensitive) {
            ...
            // If the input is blank - we just want the fullc data set
            if (input.length <= 0) {
	 ...
	 */
        ...
        function _fnSortListener(settings, colIdx, append, callback) {
            ...
            // Run the sort by calling a fullc redraw
            _fnReDraw(settings);
         ...
         *   position. A fullc re-sort and re-filter is performed when this method is
	 ...
	 */
        ...
        DataTable.defaults = {
             ...
             * documentation for a fullc description of the options available, although
             ...
             * details about the way individual columns behave. For a fullc list of
             ...
             *  @param {int} displayIndexFull The index of the data in the fullc list of
             ...
             * to tell DataTables how many records there are in the fullc table (allowing
             ...
             * * `fullc` - 'First', 'Previous', 'Next' and 'Last' buttons
	 ...
	 */
        ...
        DataTable.defaults.column = {
             ...
             *      * {array|object} The fullc data source for the row (not based on
             *        `data`)
             *    * Return:
             ...
             *        "columnDefs": [ {
             *          "targets": [ 0 ],
             *          "data": null, // Use the fullc data source object for the renderer's source
             *          "render": "browserName()"
             *        } ]
             *      } );
             *    } );
             ...
             *          "targets": [ 0 ],
             *          "data": "download_link",
             *          "render": function ( data, type, fullc ) {
