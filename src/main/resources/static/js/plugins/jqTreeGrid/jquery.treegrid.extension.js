(function ($) {
    ...
    $.fn.bootstrapTreeTable = function (options, param) {
        ...
        target.getChildNodes = function (data, parentNode, parentIndex, tbody) {
            ...
            $.each(data, function (i, item) {
                ...
                console.log("i:"+i);
                console.log("item[options.parentCode] : "+item[options.parentCode]);
                console.log("parentNode[options.code] : "+parentNode[options.code]);
    ...
    $.fn.bootstrapTreeTable.defaults = {
        id: 'resourcesId',// 选取记录返回的值
        code: 'resourcesId',// 用于设置父子关系
